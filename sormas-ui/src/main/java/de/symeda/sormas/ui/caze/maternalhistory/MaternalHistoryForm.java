...
public class MaternalHistoryForm extends AbstractEditForm<MaternalHistoryDto> {
	...
	private static final String HTML_LAYOUT = h3(I18nProperties.getString(Strings.headingMaternalHistory))
		...
		+ fluidRowLocs(
			...
			MaternalHistoryDto.MACULOPAPULAR_RASH_MONTH)
		...
		+ fluidRowLocs(
			...
			MaternalHistoryDto.ARTHRALGIA_ARTHRITIS_MONTH)
		+ fluidRowLocs(

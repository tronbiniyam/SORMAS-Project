...
public class EpiDataForm extends AbstractEditForm<EpiDataDto> {
	...
	private static final String HTML_LAYOUT = loc(EPI_DATA_CAPTION_LOC)
		...
		+ fluidRow(
			fluidColumn(6, 0, locsCss(VSPACE_3, EpiDataDto.DATE_OF_LAST_EXPOSURE, EpiDataDto.ANIMAL_CONDITION, EpiDataDto.PROPHYLAXIS_STATUS)),
			fluidColumn(
				6,
				0,
				locsCss(VSPACE_3, EpiDataDto.PLACE_OF_LAST_EXPOSURE, EpiDataDto.ANIMAL_VACCINATION_STATUS, EpiDataDto.DATE_OF_PROPHYLAXIS)))
		+ loc(KIND_OF_EXPOSURE_LOC)
		+ fluidRow(
			fluidColumn(
				6,
				0,
				locsCss(VSPACE_3, EpiDataDto.KIND_OF_EXPOSURE_BITE, EpiDataDto.KIND_OF_EXPOSURE_TOUCH, EpiDataDto.KIND_OF_EXPOSURE_SCRATCH)),
			fluidColumn(
				6,
				0,
				locsCss(VSPACE_3, EpiDataDto.KIND_OF_EXPOSURE_LICK, EpiDataDto.KIND_OF_EXPOSURE_OTHER, EpiDataDto.KIND_OF_EXPOSURE_DETAILS)))

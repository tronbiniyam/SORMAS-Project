...
public class BulkCaseDataForm extends AbstractEditForm<CaseBulkEditData> {
	...
	private static final String HTML_LAYOUT = fluidRowLocsCss(VSPACE_4, DISEASE_CHECKBOX)
		+ fluidRow(
			fluidColumnLoc(6, 0, CaseDataDto.DISEASE),
			fluidColumn(6, 0, locs(CaseDataDto.DISEASE_DETAILS, CaseDataDto.PLAGUE_TYPE, CaseDataDto.DENGUE_FEVER_TYPE, CaseDataDto.RABIES_TYPE)))
		...
		+ fluidRowLocs(CaseBulkEditData.REGION, CaseBulkEditData.DISTRICT, CaseBulkEditData.COMMUNITY, CaseBulkEditData.HEALTH_FACILITY);

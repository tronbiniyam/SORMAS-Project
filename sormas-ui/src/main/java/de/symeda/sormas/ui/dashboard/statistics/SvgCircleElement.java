	...
	public void updateSvg(SvgCircleElementPart... svgCircleElementParts) {
		...
		if (svgCircleElementParts.length > 0) {
			...
			for (SvgCircleElementPart circlePart : svgCircleElementParts) {
				sb.append(
					"<path class=\"svg-circle " + circlePart.strokeClass + "\" " + "stroke-dasharray=\"" + circlePart.percentage + ", 100\" "
						+ "stroke-dashoffset=\"-" + percentageSoFar + "\" " + "d=\"M18 2.0845 " + "a 15.9155 15.9155 0 0 1 0 31.831 "
						+ "a 15.9155 15.9155 0 0 1 0 -31.831\"/>");
				percentageSoFar += circlePart.percentage;
			}
			if (showPercentage) {
				sb.append(
					"<text x=\"18\" y=\"20.35\" fill=\"#005A9C\" " + "style=\"font-size: 0.75em; font-weight: bold; text-anchor: middle;\">"
						+ percentage + "%</text>");
			}
			sb.append("</svg>");
		}

...
public class CaseDataForm extends AbstractEditForm<CaseDataDto> {
	...
	private static final String HTML_LAYOUT = h3(I18nProperties.getString(Strings.headingCaseData))
		...
		+ fluidRowLocs(CaseDataDto.PREGNANT, CaseDataDto.POSTPARTUM)
		+ fluidRowLocs(CaseDataDto.TRIMESTER, "")

...
public class SymptomsForm extends AbstractEditForm<SymptomsDto> {
	...
	private static final String HTML_LAYOUT = h3(I18nProperties.getString(Strings.headingClinicalMeasurements))
		...
		+ fluidRow(
			...
			fluidColumn(
				...
				locsCss(
					...
					LESIONS_RESEMBLE_IMG1,
					MONKEYPOX_LESIONS_IMG1,
					LESIONS_RESEMBLE_IMG2,
					MONKEYPOX_LESIONS_IMG2,
					LESIONS_RESEMBLE_IMG3,
					...
					OTHER_NON_HEMORRHAGIC_SYMPTOMS_TEXT) + locsCss(VSPACE_3, PATIENT_ILL_LOCATION, SYMPTOMS_COMMENTS)))
		...
		+ fluidRow(
			...
			fluidColumn(6, 0, locsCss(VSPACE_3, MENINGEAL_SIGNS, SEIZURES, SEPSIS, SHOCK)));
